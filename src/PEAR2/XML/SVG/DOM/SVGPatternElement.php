...
interface SVGPatternElement
	extends SVGLangSpace,  SVGExternalResourcesRequired,  SVGStylable,  SVGFitToViewBox,  SVGUnitTypes,  SVGElement,  SVGURIReference,  SVGTests
{
	/**
	 * read-only member
	 * @var SVGAnimatedEnumeration patternUnits
	 */
	public $patternUnits;
	/**
	 * read-only member
	 * @var SVGAnimatedEnumeration patternContentUnits
	 */
	public $patternContentUnits;
	/**
	 * read-only member
	 * @var SVGAnimatedTransformList patternTransform
	 */
