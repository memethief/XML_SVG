...
interface SVGMaskElement
	extends SVGExternalResourcesRequired,  SVGStylable,  SVGUnitTypes,  SVGElement,  SVGTests,  SVGLangSpace
{
	/**
	 * read-only member
	 * @var SVGAnimatedEnumeration maskUnits
	 */
	public $maskUnits;
	/**
	 * read-only member
	 * @var SVGAnimatedEnumeration maskContentUnits
	 */
	public $maskContentUnits;
	/**
	 * read-only member
