	...
	extends SVGElement,  SVGFilterPrimitiveStandardAttributes
{
	...
	/**
	 * read-only member
	 * @var SVGAnimatedNumber stdDeviationX
	 */
	public $stdDeviationX;
	/**
	 * read-only member
	 * @var SVGAnimatedNumber stdDeviationY
	 */
	public $stdDeviationY;
	/**
	 * @param float $stdDeviationX
	 * @param float $stdDeviationY
	 * @return void
	 * @throws DOMException
	 */
	public function setStdDeviation($stdDeviationX, $stdDeviationY);
